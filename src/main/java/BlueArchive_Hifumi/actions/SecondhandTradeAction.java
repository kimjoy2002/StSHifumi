...
public class SecondhandTradeAction extends AbstractGameAction {
    ...
    public SecondhandTradeAction(int numberOfCards, boolean optional) {
    ...
    public SecondhandTradeAction(int numberOfCards) {
    ...
    static {
        uiStrings = CardCrawlGame.languagePack.getUIString("BlueArchive_Hifumi:SecondhandTradeAction");
        TEXT = uiStrings.TEXT;
    }
}
